...
const Categories = () => {
  ...
  return (
    <>
      {/* <div classNameName="pl-11 pr-11">
        <h1 classNameName="text-4xl">Business catagories</h1>
        <br />
        <marquee classNameName="" behavior="" scrollamount="5" direction="">

        <div classNameName="flex lg:justify-evenly">
          <div classNameName="">
            <img classNameName="h-40  rounded-full" src="123.webp" />
          </div>

          <div classNameName="">
            <img classNameName="h-35 w-30 rounded-full" src="" />
          </div>
          <div classNameName=""></div>
          <div classNameName="">
            <img
              classNameName="h-40 w-40"
          ...
          <div classNameName="">
            <img src="" classNameName="h-40 w-40" src="123.webp" />
          </div>
          <div>
            <img
              classNameName="h-40 w-40"
